    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                    ...
                    <li
                        ...
                        <span>
                            ...
                            <a href="https://laravel.com/docs" target="_blank"
                                class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-[#C2185B] dark:text-[#C2185B] ml-1">
            ...
            <div
                ...
                {{-- Laravel Logo --}}
                <svg class="w-full text-[#F53003] dark:text-[#C2185B] transition-all translate-y-0 opacity-100 max-w-none duration-750 starting:opacity-0 starting:translate-y-6"
