            ...
            <form action="{{ route('products.update', $product->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="category" id="category" class="form-select" required>
                        ...
                        <option value="beanies" {{ old('category', $product->category) == 'beanies' ? 'selected' : '' }}>Beanies</option>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="short" id="short" class="form-control" value="{{ old('short', $product->short) }}" required placeholder="Brief description for product cards">
                    @error('short')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="desc" id="desc" class="form-control" rows="4" required>{{ old('desc', $product->desc) }}</textarea>
                    @error('desc')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="image" id="image" class="form-control" value="{{ old('image', $product->image) }}" placeholder="e.g., product.jpg">
